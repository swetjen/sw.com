...
<section class="my-10 max-w-2xl mx-auto">
    <div class="mx-5 space-y-8">
        ...
        <div class="flex flex-row justify-between fill-current text-gray-700 space-x-12 items-center">


            <div class="text-sm p-2 bg-gray-50 rounded h-18 space-x-4 flex flex-col justify-between items-center">
            ...
            <div class="text-sm p-2 bg-gray-50 rounded h-18 space-x-2 flex flex-col justify-between items-center">
