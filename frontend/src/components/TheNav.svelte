...
<header class="bg-white my-5">
    <nav class="mx-auto flex max-w-5xl items-center justify-center py-6" aria-label="Global">
        <div class="flex lg:flex-1 lg:justify-start">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <div class="relative">
                <button on:click={() => ProductOpen = !ProductOpen} type="button" class="flex items-center gap-x-1 leading-6 nav-link" aria-expanded="false">
                    Products
                ...
                -->
                {#if ProductOpen}
                <div transition:fly="{{ y: 20, duration: 100 }}" class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                    <div class="p-4">
